...
namespace SomewhereDesktop
{
    public static class CustomCommands
    {
        ...
        public static readonly RoutedUICommand Save = new RoutedUICommand("Save current editing item/note; Used to explicitly save changes; Usually changes are saved automatically but only when text box lose focus", "Save", typeof(CustomCommands));
